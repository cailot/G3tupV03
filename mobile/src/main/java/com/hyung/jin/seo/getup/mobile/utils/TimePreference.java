...
public class TimePreference extends DialogPreference {
    ...
    public void onBindDialogView(View view) {
        ...
        timePicker.setCurrentHour(getSharedPreferences().getInt(G3tUpConstants.ALARM_HOUR, 0));
        timePicker.setCurrentMinute(getSharedPreferences().getInt(G3tUpConstants.ALARM_MINUTE, 0));
...
//            boolean c = timePicker.is24HourView();
            editor.putInt(G3tUpConstants.ALARM_HOUR, timePicker.getCurrentHour());
            editor.putInt(G3tUpConstants.ALARM_MINUTE, timePicker.getCurrentMinute());
            editor.commit();
        }
    }
}